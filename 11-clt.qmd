...
## CLT: Recap
:::{style="font-size: .8em"}
The Central Limit Theorem (CLT) is a foundational result in probability theory. While there are many versions, varying in degrees of abstraction and generality, this is the one we introduced in the last lecture.
```{python}
