...
But what if we chose bowls proportinally to their size? We would need to include that into our analysis. 
...
Let's go step by step to create a Bayes table for the cookie problem. First, we need a table that contains all possible hyptheses, one row for each hypothesis:
