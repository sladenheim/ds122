...
:::{.center-text}
<img src="images/hypothesis_testing/Fisher.jpg" width=200/>
:::
...
<br>
_**The test statistic**_ $t$ _**is equal the number of cups (out of four) correctly identified by Ms. Bristol**_.

We can then ask: what is _**the probability that Ms. Bristol would correctly identify four or more cups just by chance**_? This probability is the p-value of the experiment.
:::
...
In this case, the $p$-value would have been $p \approx 0.75$ or 75%.
