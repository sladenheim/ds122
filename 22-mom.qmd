...
In the last lecture, we discussed how to evaluate an estimator. 
...
Today we will learn how to create an estimator. In particular, we will discuss the technique known as the method of momements. It was introduced in 1894 by Karl Pearson and is the oldest method for deriving point estimators.
:::


## Learning Objectives
:::{style="font-size: .8em"}
- The definition of the $k$th (true) moment
...
$$\small \operatorname{Var}(X) = E[(X − \mu_1)^2.$$
:::
...
The Poisson distribution is a reasonable choice for modeling how often users access the feature in a week because it is commonly used to count independent events that occur at a roughly constant rate over a fixed time interval.
...
def generate_html():
   ...
   Help the student estimate the total number of episodes in the series using the method of moments.
       <br>
    <br>
    <br>
        <br>
