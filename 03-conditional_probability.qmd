...
These questions sound similar, but they are not. One way to see the difference is by comparing their answers. You will do just that in your Homework 2.
:::
...
## Independen\end{remark}ce of Events
:::{style="font-size: .8em"}
```{python}
from IPython.core.display import HTML
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
        Can you prove the Baye's rule using the chain rule?
        </p>
    </div>
    """
html_content = generate_html()
