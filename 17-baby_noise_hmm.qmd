...
- Python implementation (through a group question)
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
    Define \(A, B, \boldsymbol{\pi}, \) and \(O.\)<br>
    <br>
        </p>
    </div>
    """
...
The provided table gives the probabilities of different activity levels for when the dog is healthy and when it is sick.
 ...
 We always start with the healthy state, followed by the sick state, and activity level -1, followed by 0, followed by 1.
        </p>
    </div>
    """
html_content = generate_html()
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
b. Define \(\boldsymbol{\pi}, A,\) \(B\), and \(O\). We always start with the healthy state, followed by the sick state, and activity level -1, followed by 0, followed by 1.
<br>
<br>
<br>
        </p>
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
a. Perform the initialization stage of the Viterbi algorithm.
<br>
<br>
<br>
<br>
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
b. Perform the forward pass of the Viterbi algorithm.
<br>
<br>
<br>
<br>
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
c. Perform the backward pass of the Viterbi algorithm.
<br>
<br>
<br>
<br>
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
    Given the code below. What is the final answer for the dog's health problem?
        </p>
    </div>
    """
html_content = generate_html()
...
A = np.array([[0.9,0.3],[0.1,0.7]])
B = np.array([[0.2, 0.6],[0.6, 0.3],[0.2, 0.1]])
Pi = np.array([[0.9],[0.1]])
