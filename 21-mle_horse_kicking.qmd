---
title: Parameter Estimation Practice
...
- Practice solving MoM questions
- Practive evaluating estimators in terms of bias, variance, and MSE
...
| $x$ | $0$ | $1$ | $2$ | 
| :---: | :---: | :---: | :---: | 
| $p(x;\theta)$ | $1-\theta$ | $\frac{\theta}{2}$| $\frac{\theta}{2}$| 
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
   Suppose that \(\small X\) is a discrete random variable with the probability mass function shown above. Here \(\small 0\leq \theta \leq 1\) is a parameter. Five independent observations are made from this distribution:

    $$\small X_s = \{1,1,0,2,0\}.$$
    a. Find the likelihood function \(\small p(X_s;\theta).\)
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
   b. Find the corresponding log-likelihood function.
       <br>
    <br>
    <br>
    <br>
    <br>
    c. Find the maximum likelihood estimate (MLE) of \(\small \theta\). You do not need to confirm that the critical point is indeed a maximum.
    <br>
    <br>
    <br>
    <br>
...
def generate_html():
    ...
    <div class="blue-box">
        <p>
   d. Find the method of moments estimate of \(\theta.\)
       <br>
    <br>
    <br>
    <br>
...
## Train Problem
:::{style="font-size: .8em"}
__Example__: A railroad gives each train a number starting from 1 up to some number 𝑁. One day, you see a train with the number 60. 
