...
- First half of the lecture will be reserved for teaching evaluations
- Then we'll cover using **PyMC** for practical Bayesian inference
- And applying MCMC to a **change point detection** problem
...
**Our goal:** Detect when growth accelerated despite weekly noise
...
- Review the practice questions posted on the course website
